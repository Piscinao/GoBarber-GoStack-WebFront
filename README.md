...
<!-- To see the **api**, click here: [GoBarber Rest API](https://github.com/Piscinao/gobarber-api)</br>
To see the **mobile client**, click here: [GoBarber Mobile](https://github.com/Piscinao/gobarber-mobile) -->
...
Soon
<!-- - Have this application's [API](https://github.com/Piscinao/gobarber-api) running -->

**Clone the project and access the folder**

```bash
$ git clone https://github.com/Piscinao/Piscinao-GoBarber-GoStack-WebFront.git && cd gobarber-web
```
...
$ gh repo fork Piscinao/gobarber-web
```
